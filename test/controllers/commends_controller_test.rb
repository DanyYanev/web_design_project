...
class CommendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commend" do
    assert_difference('Commend.count') do
      post commends_url, params: { commend: { body: @commend.body, post_id: @commend.post_id } }
    end
  ...
  test "should update commend" do
    patch commend_url(@commend), params: { commend: { body: @commend.body, post_id: @commend.post_id } }
